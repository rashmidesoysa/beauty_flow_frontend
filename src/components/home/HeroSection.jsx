      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          <div className="animate__animated animate__fadeInUp">
            <p className="text-pink-400 font-semibold mb-4">WELCOME TO BEAUTY FLOW</p>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Discover Your <span className="text-pink-400">Natural Beauty</span>
            </h1>
            <p className="text-gray-200 text-lg mb-8">
              Explore our curated collection of premium beauty products. 
              Quality ingredients, sustainable packaging, and results you'll love.
            </p>
