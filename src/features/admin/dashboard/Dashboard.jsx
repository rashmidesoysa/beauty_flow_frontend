...
const OrderStatus = ({ status }) => {
  const statusConfig = {
    ...
    processing: { color: 'bg-blue-100 text-blue-700', icon: FaTruck, label: 'Processing' },
    completed: { color: 'bg-green-100 text-green-700', icon: FaCheckCircle, label: 'Completed' },
    cancelled: { color: 'bg-red-100 text-red-700', icon: FaExclamationTriangle, label: 'Cancelled' }
  }
...
export default function Dashboard() {
  ...
  const [recentOrders, setRecentOrders] = useState([
    { id: '#1001', customer: 'Sarah Johnson', amount: 125.00, status: 'pending', date: '2024-01-15', items: 3 },
    { id: '#1002', customer: 'Michael Chen', amount: 89.99, status: 'processing', date: '2024-01-15', items: 2 },
    { id: '#1003', customer: 'Emma Williams', amount: 245.50, status: 'completed', date: '2024-01-14', items: 5 },
    { id: '#1004', customer: 'James Brown', amount: 67.90, status: 'pending', date: '2024-01-14', items: 1 },
    { id: '#1005', customer: 'Lisa Anderson', amount: 189.99, status: 'completed', date: '2024-01-13', items: 4 },
  ])
  ...
  const salesData = {
    ...
    datasets: [
      {
        label: 'Revenue 2024',
        data: [12500, 15200, 16800, 18900, 21500, 23400, 25600, 27800, 29500, 31200, 33500, 35800],
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-3 py-1 bg-pink-600 text-white rounded-lg hover:bg-pink-700">Next</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-xl p-6 text-white">
          ...
          <p className="text-sm opacity-90">8 products are running low on stock</p>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white">
          ...
          <p className="text-sm opacity-90">12 customer reviews awaiting moderation</p>
          <button className="mt-3 px-4 py-1 bg-white/20 rounded-lg text-sm hover:bg-white/30 transition">
            Moderate Reviews
          </button>
        </div>
