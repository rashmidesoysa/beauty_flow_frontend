      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-8 flex flex-wrap justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2">
              <button className="px-3 py-1 bg-pink-100 text-pink-600 rounded-full text-sm">
                All
              </button>
              <button className="px-3 py-1 hover:bg-pink-50 text-gray-600 rounded-full text-sm">
                Makeup
              </button>
              <button className="px-3 py-1 hover:bg-pink-50 text-gray-600 rounded-full text-sm">
                Skincare
          ...
          {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-pink-600 font-bold">LKR 49.99</p>
        ...
        <div className="mt-12 flex justify-center">
          <div className="flex gap-2">
            ...
            <button className="px-3 py-1 bg-pink-600 text-white rounded-lg">
              1
            </button>
            <button className="px-3 py-1 border rounded-lg hover:bg-gray-50">
              2
